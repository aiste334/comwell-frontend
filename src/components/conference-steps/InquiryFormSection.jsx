...
function InquiryFormSection({
  selectedRoom, selectedHotel, rooms, dates, times, 
  onConferenceClick, conferenceParticipantCount, formSteps, 
  closeBookingDrawer, closeDrawer, hotels, selectedConference
}) {
  ...
  const infoHeader = <ConferenceInfoHeader conferenceParticipantCount={conferenceParticipantCount} dates={dates} />;
    ...
    <FormStepGroup currentStep={currentStep}>
      ...
      <FormStep onReturn={prev}>
        <BookingStepLayout
          ...
          disabled={!loggedIn || !agreeWithTC || !company}
        >
          <InquiryInfoContent
            dates={dates}
            times={times}
