...
const SideDrawer = ({ isOpen, onClose = () => {}, children, animationDuration = 300, className }) => {
  ...
  return (
    ...
    >
      <div 
        className={`ml-auto min-w-[360px] overflow-auto bg-white h-screen px-4 pt-8 pb-4 cursor-default transition-all duration-[${animationDuration}ms] ${translateSnippet} ${className}`} 
