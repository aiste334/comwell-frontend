...
const SideDrawer = ({ isOpen, onClose = () => {}, children, animationDuration = 300, className }) => {
  ...
  return (
    ...
    >
      <div 
        className={`fixed top-0 overflow-auto right-0 min-w-[360px] bg-white h-full ml-auto px-4 pt-8 cursor-default transition-all duration-[${animationDuration}ms] ${translateSnippet} ${className}`} 
