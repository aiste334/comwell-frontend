...
const DoubleSelect = ({ onClick, titles, values }) => {
  const isMonoClick = !Array.isArray(onClick)
  return (
    <button onClick={isMonoClick ? onClick : () => {}} 
      ...
      <div className='flex flex-col text-left w-full relative' onClick={!isMonoClick ? onClick[0] : () => {}}>
      ...
      <div className='flex flex-col text-left w-full relative border-l-cw-gray-300 border-l-[1px] pl-3 -mr-3' onClick={!isMonoClick ? onClick[1] : () => {}}>
