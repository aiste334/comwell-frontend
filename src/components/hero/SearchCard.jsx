    ...
    <div className={'bg-white rounded-2xl w-[530px] p-8 drop-shadow-lg ' + className}>
      ...
      <TabGroup className="py-2">
        <Tab title="Overnatning" className="flex flex-col gap-3">
          <Select title="Hotel" onClick={() => {}}>Select hotel</Select>
          <Select title="Rooms" onClick={() => {}}>1 Room, 1 Person</Select>
          <DoubleSelect titles={["Check-in", "Check-out"]} values={["Nov 6", "Nov 7"]} onClick={() => {}}/>
          <PrimaryButton>
            Book
